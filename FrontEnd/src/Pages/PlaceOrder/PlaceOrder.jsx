    ...
    return (
        <form onSubmit={placeOrder} className='place-order'>
            <div className="place-order-left">
                ...
                <div className="multi-fields">
                    <input required name='zipCode' onChange={onChangeHndler} value={data.zipCode} type="text" placeholder='Zip Code' />
                    <input required name='country' onChange={onChangeHndler} value={data.country} type="text" placeholder='Country' />
                </div>
                <input required name='phone' onChange={onChangeHndler} value={data.phone} type="text" placeholder='Phone' />
            </div>
